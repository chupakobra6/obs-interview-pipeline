...
| S013 | user + experiment report | 2026-08-02 | `.project-loop/intake/raw/adaptive-multilingual-asr-selection.md`, installed `whisper.cpp@v1.9.1`, multilingual benchmark corpus | принято, исследование в работе | Требуется выбрать одну адаптивную OBS long-form политику по quality/performance/complexity, проверить punctuated prompt и альтернативы на русском/английском и сократить публичные ASR-режимы до необходимого минимума. |
