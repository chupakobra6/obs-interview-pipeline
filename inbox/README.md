...
Прежние таблицы, планы и журналы процесса доступны в Git: `76a74f4`, каталог `.project-loop/`. Старые пути и ID в неизменённых источниках относятся к этой версии.
